...
function eur_EOP_units.populateEDB()
    ...
    if equestrianBuild then
     ...
     --equestrian level 2    
        ...
        EDB.addBuildingPool(equestrianBuild, 0, 1097, 1.0, 0.08, 2.0, 0.0, "factions { ireland, } and region_religion elven 50 ");
    ...
    if c_equestrianBuild then
        ...
        EDB.addBuildingPool(c_equestrianBuild, 0, 1097, 1.0, 0.08, 2.0, 0.0, "factions { ireland, } and region_religion elven 50 ");
